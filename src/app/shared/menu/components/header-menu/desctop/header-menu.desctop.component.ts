...
@Component({
  selector: 'app-header-menu-desctop',
  templateUrl: './header-menu.desctop.component.html',
  styleUrls: ['./header-menu.desctop.component.css']
})
export class HeaderMenuDesctopComponent implements OnInit {
